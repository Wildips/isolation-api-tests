...
from contracts.services.accounts.account_pb2 import Account, ACCOUNT_TYPE_CREDIT_CARD, ACCOUNT_STATUS_ACTIVE, \
    ACCOUNT_TYPE_DEBIT_CARD
from contracts.services.cards.card_pb2 import Card, CARD_STATUS_ACTIVE, CARD_TYPE_VIRTUAL, CARD_TYPE_PHYSICAL, \
    CARD_PAYMENT_SYSTEM_VISA, CARD_PAYMENT_SYSTEM_MASTERCARD
        ...
        details=AccountDetails(
            ...
            cards=[
                Card(
                    ...
                    payment_system=CARD_PAYMENT_SYSTEM_VISA,
                ),
                Card(
